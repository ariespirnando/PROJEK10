                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="<?php echo base_url()?>index.php/admin/pelanggan">Pelanggan</a></li>
                            <li><a href="<?php echo base_url()?>index.php/admin/pendaftaran">Pendaftaran</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo base_url()?>index.php/admin/laporanPendaftarn"><font color="000000">Data Pendaftaran</font></a></li>
                                    <li><a href="<?php echo base_url()?>index.php/admin/laporanTransaski"><font color="000000">Data Transaksi</font></a></li>
                                </ul>
                            </li>
